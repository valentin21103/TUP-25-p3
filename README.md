...
> Crear Rama llamada "TP2-<Legajo>"
> El pull request tambien debe llevar como titulo "TP2 - <Legajo> - <NombreCopleto>"
...
## Entrega:
El trabajo debe ser resuelto en el archivo `ejercicio.cs`, debe incluir todas las clases en un unico archivo y debe poder ejecutarse como un script (No crear un proyecto)