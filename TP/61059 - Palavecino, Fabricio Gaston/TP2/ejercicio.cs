using sistem console;

namespace tp2
{
    abstract class Cuenta(string numero, double saldo)
    {
        public string Numero { get; private set; } = numero;
        public double Saldo { get; protected set; } = saldo;
        public double Puntos { get; protected set; } = 0;
    ...
    class CuentaOro(string numero, double saldo) : Cuenta(numero, saldo)
    {
    ...
    class CuentaPlata(string numero, double saldo) : Cuenta(numero, saldo)
    {
        public override void Pagar(double monto)
        {
    ...
    class CuentaBronce(string numero, double saldo) : Cuenta(numero, saldo)
    {
        public override void Pagar(double monto)
        {
