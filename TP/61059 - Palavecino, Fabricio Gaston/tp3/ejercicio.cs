...
class Contacto : IComparable<Contacto>
{
    ...
    public override int GetHashCode()
    {
        ...
        lista.Eliminar(2);
        Assert(lista.Cantidad, 3, "Cantidad de elementos tras eliminar un elemento que si existente");
        Assert(lista[0], 1, "Primer elemento tras eliminar 2");
        Assert(lista[1], 3, "Segundo elemento tras eliminar 2");
        lista.Eliminar(100);
        Assert(lista.Cantidad, 3, "Cantidad de elementos tras eliminar un elemento que no existe");
