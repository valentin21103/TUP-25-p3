...
// Definiciones 
var ricardo = new Cliente("Ricardo Fort");
    ricardo.Agregar(new CuentaOro("10001", 1000));
    ricardo.Agregar(new CuentaPlata("10002", 2000));

var shakira = new Cliente("Shakira Mebarak");
    shakira.Agregar(new CuentaPlata("10003", 3000));
    shakira.Agregar(new CuentaPlata("10004", 4000));

var messi = new Cliente("Lionel Messi");
    messi.Agregar(new CuentaBronce("10005", 5000));

var nac = new Banco("Banco Nacional");
nac.Agregar(ricardo);
nac.Agregar(shakira);
